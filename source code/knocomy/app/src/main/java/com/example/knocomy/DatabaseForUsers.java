...
public class DatabaseForUsers extends SQLiteOpenHelper {
    ...
    public void veriEkle(String nick, String psswd)
    {
    ...
    public String searchPass(String nick, int columnIndex)
    {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<String> vericek(int id)
    {
    ...
    public void veriGuncelle(String nick, int score)
    {
        SQLiteDatabase db = this.getWritableDatabase();
